...
Mobile.waitForElementPresent(findTestObject('RS/home_option'), GlobalVariable.G_LongTimeOut)
Mobile.tap(findTestObject('RS/home_option'), GlobalVariable.G_Timeout)
